  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 py-10 bg-amber-50">
      ...
      <div className="mt-8 grid w-full max-w-sm grid-cols-3 gap-3 sm:max-w-xl">
        <FeatureItem
          name="lucide:zap"
          title={messages.landing.featureFastTitle}
          description={messages.landing.featureFastDesc}
        />
        <FeatureItem
          name="lucide:wifi-off"
          title={messages.landing.featureOfflineTitle}
          description={messages.landing.featureOfflineDesc}
        />
        <FeatureItem
          name="lucide:bar-chart-2"
          title={messages.landing.featureReportTitle}
          description={messages.landing.featureReportDesc}
        />
      </div>
    </div>
  );
